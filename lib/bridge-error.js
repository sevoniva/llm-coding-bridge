...
function classificationFor(error, status) {
  ...
  const transportCode = causeCode || sourceCode;
  ...
  if (transportCode === "UND_ERR_CONNECT_TIMEOUT" || transportCode === "ETIMEDOUT") {
