...
function safeOptions(options) {
  ...
  try {
    ...
    const read = (key) => {
      ...
      if (!Object.hasOwn(descriptor, "value") || typeof descriptor.value !== "string" || !SAFE_IDENTIFIER.test(descriptor.value)) throw localConfigError("INVALID_REQUEST_STATE_OPTIONS");
      return descriptor.value;
    };
    return { requestId: read("requestId"), model: read("model") };
  } catch (error) {
